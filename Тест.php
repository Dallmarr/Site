                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="text-center" id="author">
                            <img src="Ав.jpg">
                            <h3>Андрей Шашков</h3>
                            <small class="label label-warning">Роиссейская Федерация</small>
                            <p>Что ты хочешь тут увидеть?</p>
                        ...
                        <div id="myTabContent" class="tab-content">
                            ...
                            <div class="tab-pane fade active in" id="detail">
                                ...
                                <table class="table table-th-block">
                                    ...
                                    <tr><td class="active">Последняя активность:</td><td>15-09-2077 / 9:19</td></tr>
                                    <tr><td class="active">Страна:</td><td>Россия</td></tr>
                                    <tr><td class="active">Город:</td><td>Деревня Цыганово</td></tr>
                                    <tr><td class="active">Пол:</td><td>Мужской</td></tr>
                                    <tr><td class="active">Полных лет:</td><td>14</td></tr>
